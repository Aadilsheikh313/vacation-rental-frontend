...
import styles from "../../adminStylesModule/Guest/admingetalllogout.module.css";
...
import { getAllLogoutGuest } from "../../config/redux/action/adminGuestAction";
import CustomSpinner from "../../comman/Spinner";

const AdminGetLogoutGuest = () => {
    ...
    return (
        <div className={styles.logoutGuestsContainer}>
            <div className={styles.tableWrapper}>
                <Card className={styles.summaryCard}>
                    <Card.Body>
                        <h3>Total Logout Registered Guest : <span>{logoutGuestsCount}</span></h3>
                    </Card.Body>
                </Card>
                ...
                {isSuccess && logoutGuests.length === 0 && (
                    <p className={styles.noGuestsText}>No Logout guests found.</p>
                )}

                {!isLoading && logoutGuests.length > 0 && (
                    <div className={styles.tableWrapper}>
...
export default AdminGetLogoutGuest;
