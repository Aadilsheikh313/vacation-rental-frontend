...
import styles from "../stylesModule/Amenites/AmenitiesEdit.module.css";
...
const AmenitiesEditForm = ({ propertyId }) => {
  ...
  const handleUpdate = (e) => {
    e.preventDefault();
    dispatch(amenitiesUpdate({ propertyId, amenitiesData: formData }));
  };
  ...
  return (
    <form className={styles.AmenitiesConatainer}>
      ...
      <div className={styles.buttonGroup}>
        ...
        >
          {isLoading ? "Updating..." : "Update Amenities"}
        </button>
      </div>
